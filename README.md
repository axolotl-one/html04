...
Primera práctica del módulo explorando los tipos de datos y como los interpreta el lenguaje de JavaScript. Práctica introductoria que solicita al usuario ingresar tres tipos de datos por medio de windows.prompt() y los muestra en pantalla. También imprime en consola los tipos de datos que se definieron como nulo, no asignado, booleano y de escape.

### 5.2 Creación del index.html para el menú de páginas

Este repositorio pretende englobar todas las prácticas del módulo y acceder por medio de páginas HTML a través de anclas alojadas en el _index.html_

### 6.0 Actividad 2: Estructuras de Selección

Solicita al usuario ingresar su calificación en una escala de cero a cien por medio de un windows.prompt(), devolviendo la nota que correspone a menos de 60 como _insuficiente,_ menos de 75 como _suficiente,_ menos de 90 como _buena,_ menos de 100 como _excelente,_ y 100 como _máxima._ Si el usuario ingresa un valor fuera del rango, mostrará que su valor se encuentra fuera del rango. Si el valor capturado no es un número, mostrará el mensaje de que el valor no es un número.

### 7.0 Practica 1: Piedra, Papel o Tijeras plus
